...
## 5. Anthropic（Claude）のAPIキーを取得する
...
| 症状 | 原因と対処 |
|---|---|
| ログインできない/登録できない | Supabaseの手順2(RLS)を忘れていないか確認。Project Settings→API のURL/キーが正しいかも確認 |
